...
import java.awt.event.*;	
   ...
   // actionPerformed(): run button action event handler	
      ...
      // get user's responses 	
         ...
         if(won){
            JOptionPane.showMessageDialog(null,"You won!","Tic_Tac_Toe",-1,new ImageIcon("winner.jpg"));
            for(int r=0;r<m.length;r++)
               for(int c=0;c<m[r].length;c++){
                  m[r][c].setText("");
         ...
         if(won){
            JOptionPane.showMessageDialog(null,"You Lose...","Tic_Tac_Toe",-1,new ImageIcon("loser.jpg"));
            for(int r=0;r<m.length;r++)
               for(int c=0;c<m[r].length;c++){
                  m[r][c].setText("");
                  m[r][c].setIcon(new ImageIcon("yellow.jpg"));}
