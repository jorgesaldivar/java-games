...
public class ObjetoMasBoleana {
	
	private int posX;    //posicion en x.       
	private int posY;	//posicion en y.
	private ImageIcon icono;    //icono.
	private boolean boleana;
	private boolean boleana2;
	 ...
	 */
	public ObjetoMasBoleana(int posX, int posY ,Image image,boolean boleana,boolean boleana2) {
		this.posX=posX;
		this.posY=posY;
		icono = new ImageIcon(image);	
		this.boleana=boleana;
	}
	
	public void setBoolean(boolean boleana){
		this.boleana=boleana;
	}
	...
	public void setBoolean2(boolean boleana2){
		this.boleana2=boleana2;
	}
